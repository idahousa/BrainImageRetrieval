...
"""=================================================================================================================="""
"""Class for evaluating the metrics of 2D image segmentation"""
class SegMetrics:
...
"""Class for evaluating the metrics of 3D image segmentation"""
"""Use this bellow class when all test 2D images are from an 3D image volume"""
class SegMetrics3D:
    def __init__(self):
        self.TPs = 0.
        self.TNs = 0.
