...
"""=====================================================================================================================
Note: 
   - y_true: one-hot encoding of class label (range (0,1))
   - y_pred: raw output of model (range (-inf, +inf))
====================================================================================================================="""
class Losses:
    def __init__(self):
        pass
    ...
    def sweighted_ce(i_y_true, i_y_pred):
        ...
        return Losses.weighted_ce(i_weights=weights)(i_y_true=i_y_true, i_y_pred=i_y_pred)
    @staticmethod
    ...
    def compile(i_net=None, i_lr=0.001, i_loss_name='wCE', i_weights=None):
        ...
        if i_loss_name == 'wCE':
            loss = Losses.weighted_ce(i_weights=i_weights)
        elif i_loss_name == 'swCE':
            loss = Losses.sweighted_ce
        elif i_loss_name == 'FL':
            loss = Losses.focal_loss(i_gamma=2.0, i_alpha=0.25)
        else:
    ...
    def get_custom_objects():
        custom_objects = {'get_wce'     : Losses.weighted_ce(i_weights=[0.45, 0.55]),
                          'sweighted_ce': Losses.sweighted_ce,
                          'get_fl'      : Losses.focal_loss(i_gamma=2., i_alpha=0.25)}
...
if __name__ == '__main__':
    print('This module is to implement some custom losses for a classification system')
"""=================================================================================================================="""